...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl transition-colors duration-300 dark:text-white"
      ...
      >
        ...
        >
          Checkout CV{" "}
          <FaCheck className=" opacity-60 group-hover:translate-x-2 transition" />
        </Link>
